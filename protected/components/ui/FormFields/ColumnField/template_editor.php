    ...
    <tr>
        <td ng-if='field.totalColumns >= 1'
            ...
            <ol ui-tree-nodes ng-model="field.column1">
                <li ng-class="{inline:field.displayInline}" ng-repeat="field in field.column1" ui-tree-node ng-include="'FormTree'" ng-class="{
        ...
        <td ng-if='field.totalColumns >= 2'
            ...
            <ol ui-tree-nodes ng-model="field.column2">
                <li ng-class="{inline:field.displayInline}" ng-repeat="field in field.column2" ui-tree-node ng-include="'FormTree'" ng-class="{
                                cpl: isPlaceholder(field)
                            }"></li>
            </ol>
        </td>
        <td ng-if='field.totalColumns >= 3'
            ...
            <ol ui-tree-nodes ng-model="field.column3">
                <li ng-class="{inline:field.displayInline}" ng-repeat="field in field.column3" ui-tree-node ng-include="'FormTree'" ng-class="{
                                cpl: isPlaceholder(field)
                            }"></li>
            </ol>
        </td>
        <td ng-if='field.totalColumns >= 4'
            ...
            <ol ui-tree-nodes ng-model="field.column4">
                <li ng-class="{inline:field.displayInline}" ng-repeat="field in field.column4" ui-tree-node ng-include="'FormTree'" ng-class="{
                                cpl: isPlaceholder(field)
                            }"></li>
            </ol>
        </td>
        <td ng-if='field.totalColumns >= 5'
            ...
            <ol ui-tree-nodes ng-model="field.column5">
                <li ng-class="{inline:field.displayInline}" ng-repeat="field in field.column5" ui-tree-node ng-include="'FormTree'" ng-class="{
                                cpl: isPlaceholder(field)
                            }"></li>
            </ol>
        </td>
