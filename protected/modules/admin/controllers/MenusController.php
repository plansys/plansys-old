...
class MenusController extends Controller {
    ...
    public function actionRenderProperties() {
        $properties = FormBuilder::load('AdminMenuEditor');

        if ($this->beginCache('AdminMenuProperties', array(
                    'dependency' => new CFileCacheDependency(
                            Yii::getPathOfAlias('application.modules.admin.forms.AdminMenuEditor') . ".php"
            )))) {
