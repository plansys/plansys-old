...
class ActiveJoinElement {
	...
	/**
	 * @var boolean datasource counter marker flag, when true will replace select column with count(*)
	 */
	public $dsCountCol = false;
	 ...
	 * @param ActiveJoinElement $fke the join element containing foreign keys
	 * @param array $fks the foreign keys
	 * @param ActiveJoinElement $pke the join element contains primary keys
	 * @param ActiveJoinElement $parent the parent join element
