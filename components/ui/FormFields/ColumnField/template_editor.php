...
<table style="width:100%;">
    <tr>
        <td ng-if='field.totalColumns >= 1'
            class="form-builder-column first {{field.totalColumns==1?'last':''}}" style='width:{{field.w1}}'>
        ...
        <td ng-if='field.totalColumns >= 2'
            class="form-builder-column {{field.totalColumns==2?'last':''}}" style='width:{{field.w2}}'>
        ...
        <td ng-if='field.totalColumns >= 3'
            class="form-builder-column {{field.totalColumns==3 ?'last':''}}" style='width:{{field.w3}}'>
        ...
        <td ng-if='field.totalColumns >= 4'
            class="form-builder-column {{field.totalColumns==4?'last':''}}" style='width:{{field.w4}}'>
        ...
        <td ng-if='field.totalColumns >= 5'
            class="form-builder-column {{field.totalColumns==4?'last':''}}" style='width:{{field.w5}}'>
