<?php
class ExportWord extends CComponent {
     ...
     */
    public static function download($fileNameResource, $fileNameResult, $data) {
        $extResource = 'docx';
        $extResult = 'docx';
        $fileNameResult = $fileNameResult.'.'.$extResult;
        ...
        // Include classes
        require_once Yii::getPathOfAlias('application.vendor.ertong.tbs.opentbs.demo.tbs_class') . '.php';
        require_once Yii::getPathOfAlias('application.vendor.ertong.tbs.opentbs.tbs_plugin_opentbs') . '.php';
